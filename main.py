...
class BuzzLogin:
    def __init__(self, root):
        self.root = root
        self.root.title("Buzzlight - Вход")
    ...
    def setup_ui(self):
        ...
        register_label = tk.Label(
            main_frame,
            text="Ещё нет аккаунта? Зарегистрироваться в Spotify",
            font=('Arial', 10, 'underline'),
            fg='#B3B3B3',
            bg='#121212',
            cursor='hand2'
...
class BuzzReg():
    def __init__(self, root):
        self.root = root
        self.root.title("Buzzlight - Регистрация")
...
class App():
    def __init__(self, root):
        ...
        self.login_window = BuzzLogin(root)
        self.reg_window = BuzzReg(root)
